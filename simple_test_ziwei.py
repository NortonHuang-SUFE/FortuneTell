...
class SolarAPI:
    ...
    def get_astrolabe_data(self, date, timezone, gender, period, is_solar=True):
        ...
        :param gender: 性别字符串
        :param period: 时间周期，格式为 "YYYY-MM-DD"
...
if __name__ == "__main__":
    ...
    try:
        solar_result = solar_api.get_astrolabe_data("2000-8-16", 2, "女", ["2000-8-16", "2001-8-17", "2002-8-18"], is_solar=True)
        print("阳历响应内容:", solar_result)

        lunar_result = solar_api.get_astrolabe_data("2000-8-16", 2, "女", ["2000-8-16", "2000-8-17", "2000-8-18"], is_solar=False)
